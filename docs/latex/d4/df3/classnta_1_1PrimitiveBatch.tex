...
\item[\hyperlink{todo__todo000002}{Todo}]Render all Primitives using trianges since \end{DoxyRefDesc}
...
\item[\hyperlink{todo__todo000001}{Todo}]store primitives on the stack \end{DoxyRefDesc}
