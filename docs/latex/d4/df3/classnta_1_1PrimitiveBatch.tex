...
\item[\hyperlink{todo__todo000004}{Todo}]Render all Primitives using trianges since \end{DoxyRefDesc}
...
\item[\hyperlink{todo__todo000002}{Todo}]store primitives on the stack \end{DoxyRefDesc}
