...
\item[\hyperlink{todo__todo000024}{Todo}]Render all Primitives using trianges since \end{DoxyRefDesc}
...
\item[\hyperlink{todo__todo000009}{Todo}]store primitives on the stack \end{DoxyRefDesc}
