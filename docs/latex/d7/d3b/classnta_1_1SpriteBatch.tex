...
\item[\hyperlink{todo__todo000011}{Todo}]Allow for custom vertex types \end{DoxyRefDesc}
...
\item[\hyperlink{todo__todo000013}{Todo}]Give some of these different names? \end{DoxyRefDesc}
