...
\item[\hyperlink{todo__todo000008}{Todo}]Redo libraries error-\/handling model so it doesn\textquotesingle{}t just always crash Idea\+: Error\+Manager with linked list of errors? \end{DoxyRefDesc}
